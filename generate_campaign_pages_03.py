...
# Limite conservador para evitar rutas largas en Windows
MAX_SLUG_LEN = 120
...
def generate_pages_and_permalink_csv(csv_path: str, permalink_csv_out: str, clean: bool = False):
    ...
    # Escribir CSV de permalinks (aunque haya fallas parciales)
...
if __name__ == "__main__":
    ...
    # Normalizar YEAR_ROOT a path web absoluto tipo /awards/.../<year>/
    ...
    # Destino del CSV de permalinks:
    if args.permalink_csv_out:
        permalink_csv_out = args.permalink_csv_out
    else:
        # por defecto, escribir en ./<YEAR_ROOT local>/data/<input>_permalinks.csv
        in_path = pathlib.Path(args.csv)
        base_name = in_path.stem + "_permalinks" + in_path.suffix
        year_root_local = "." + YEAR_ROOT  # ej: "./awards/canneslions/2021/"
